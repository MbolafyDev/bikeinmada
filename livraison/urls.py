...
urlpatterns = [
    ...
    path('ajouter/', views.ajouter_livreur, name='ajouter_livreur'),
    path('modifier/<int:id>/', views.modifier_livreur, name='modifier_livreur'),
    path('supprimer/<int:id>/', views.supprimer_livreur, name='supprimer_livreur'),
